...
// function to generate the pipeline for fetching favorite emails
exports.getFavoriteMailsPipeline = (userId, mailboxType) => {
  return [
    ...
    // match emails that are not deleted but marked as favorite
    {
      $match: {
        [`${mailboxType}.deleted`]: false,
        [`${mailboxType}.isFavorite`]: true
      }
    },
